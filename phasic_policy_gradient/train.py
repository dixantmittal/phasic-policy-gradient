...
def train_fn(
    ...
    # 'detach' = shared policy and value networks, but with the value function gradient detached during the
    #            policy phase to avoid interference
